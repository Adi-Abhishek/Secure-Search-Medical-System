...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("atype"))
							{
								atype=multi.getParameter(paramname);
							}
					...
					if ( rs1.next() )
					   ...
					   {
					PreparedStatement ps=connection.prepareStatement("insert into dataowner(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,atype) values(?,?,?,?,?,?,?,?,?,?,?,?)");
